...
public class PizzaStreams {
    ...
    public Stream<Pizza> getPizzasWithPineapple(Stream<Pizza> pizzas) {
         ...
         */
        Stream<Pizza> n = pizzas.filter(x -> x.toppings().contains("pineapple"));
        return n;
    }
    ...
    public Stream<Pizza> getPizzasWithoutPineapple(Stream<Pizza> pizzas) {
         ...
         */
        Stream<Pizza> n = pizzas.filter(x -> x.toppings().contains("pineapple") == false);
        return n;
    }
    ...
    public Stream<Pizza> getPizzasWithTopping(Stream<Pizza> pizzas, String topping) {
         ...
         * always in lower case.
         */
        Stream<Pizza> n = pizzas.filter(x -> x.toppings().contains(topping));
        return n;
    }
    ...
    public Stream<Pizza> getPizzasWithAnyOfToppings(Stream<Pizza> pizzas, List<String> toppings) {
        ...
        Stream<Pizza> n = pizzas.filter(x -> x.toppings().stream().anyMatch(toppings::contains) == true);
        return n;
    }
    ...
    public Stream<Pizza> sortPizzasByPrice(Stream<Pizza> pizzas) {
         ...
         */
        Stream<Pizza> n = pizzas.sorted(Comparator.comparing(Pizza::price));
    ...
    public Stream<Pizza> sortPizzasByName(Stream<Pizza> pizzas) {
         ...
         * pizzas.
         */
        Stream<Pizza> n = pizzas.sorted(Comparator.comparing(Pizza::name));
        return n;
    }
}
